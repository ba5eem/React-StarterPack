This is a personal use React Template/Boiler Plate starter pack - it includes all the necessary folders/files/node modules to begin a simple project.  After git clone please:
//1. Create branch
2. npm install
